...
function generarGrafico(totales) {
    ...
    var options = {
        ...
        xaxis: {
            categories: ['Ene', 'Feb', 'Mar', 'Abr', 'May', 'Jun', 'Jul'], // Nombres de los meses abreviados
            labels: {
...
async function cargarYMostrarGastos() {
    const urlMesActual = 'https://recaudaciones.s3.us-east-2.amazonaws.com/DATOS-JULIO-24/GASTOSUC.json';
