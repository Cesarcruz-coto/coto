...
const mesAnterior = datosFijos2024['Jun'];  // Asumiendo que 'SEP' es el mes anterior
...
function renderizarGraficoCodigo3(resumen) {
    ...
    const datosMensuales2024 = {
        ...
        'May': 141,
        'Jun': 151,
        'Jul': datosCodigo3.total // Fallos reales para noviembre
    };
...
function renderizarGraficoCodigo2(resumen) {
    ...
    const datosMensuales2024 = {
        ...
        'May': 94,
        'Jun': 136,
        'Jul': datosCodigo2.total // Fallos reales para noviembre
    };
...
function renderizarGraficoCodigo1(resumen) {
    ...
    const datosMensuales2024 = {
        ...
        'May': 234,
        'Jun': 268,
        'Jul': datosCodigo1.total // Fallos reales para noviembre
    };
