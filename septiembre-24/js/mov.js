const apiUrl = 'https://recaudaciones.s3.us-east-2.amazonaws.com/DATOS-SEPTIEMBRE-24/MOVACONCILIAR.json';
...
function buscarNoCompensados() {
    ...
    const filteredMovimientos = movimientosNoCompensados.filter(mov => 
        mov.Suc && String(mov.Suc).toLowerCase().includes(searchTerm)
    );
