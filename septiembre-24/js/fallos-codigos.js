...
const mesAnterior = datosFijos2024['Ago'];  // Asumiendo que 'SEP' es el mes anterior
...
function renderizarGraficoCodigo3(resumen) {
    ...
    const datosMensuales2024 = {
        ...
        'Jul': 174,
        'Ago': 49,
        'Sep': datosCodigo3.total // Fallos reales para noviembre
    };
...
function renderizarGraficoCodigo2(resumen) {
    ...
    const datosMensuales2024 = {
        ...
        'Jul': 150,
        'Ago': 165,
        'Sep': datosCodigo2.total // Fallos reales para noviembre
    };
...
function renderizarGraficoCodigo1(resumen) {
    ...
    const datosMensuales2024 = {
        ...
        'Jul': 316,
        'Ago': 146,
        'Sep': datosCodigo1.total // Fallos reales para noviembre
    };
