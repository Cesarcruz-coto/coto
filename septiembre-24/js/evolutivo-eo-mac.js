// URLs de las APIs
const apiErroresActual = 'https://recaudaciones.s3.us-east-2.amazonaws.com/DATOS-SEPTIEMBRE-24/ERROROPERATIVO.json';
const apiErroresJulio = 'https://recaudaciones.s3.us-east-2.amazonaws.com/DATOS-JULIO-24/ERROROPERATIVO.json';
const apiErroresAgosto = 'https://recaudaciones.s3.us-east-2.amazonaws.com/DATOS-AGOSTO-24/ERROROPERATIVO.json';

const apiMovimientosActual = 'https://recaudaciones.s3.us-east-2.amazonaws.com/DATOS-SEPTIEMBRE-24/MOVACONCILIAR.json';
const apiMovimientosJulio = 'https://recaudaciones.s3.us-east-2.amazonaws.com/DATOS-JULIO-24/MOVACONCILIAR.json';
const apiMovimientosAgosto = 'https://recaudaciones.s3.us-east-2.amazonaws.com/DATOS-AGOSTO-24/MOVACONCILIAR.json';
