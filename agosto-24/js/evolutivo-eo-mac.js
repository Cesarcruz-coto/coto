// URLs de las APIs
const apiErroresActual = 'https://cesarcruz-coto.github.io/coto/DATOS-AGOSTO-24/ERROROPERATIVO.json';
const apiErroresJulio = 'https://cesarcruz-coto.github.io/coto/DATOS-JUNIO-24/ERROROPERATIVO.json';
const apiErroresAgosto = 'https://cesarcruz-coto.github.io/coto/DATOS-JULIO-24/ERROROPERATIVO.json';

const apiMovimientosActual = 'https://cesarcruz-coto.github.io/coto/DATOS-AGOSTO-24/MOVACONCILIAR.json';
const apiMovimientosJulio = 'https://cesarcruz-coto.github.io/coto/DATOS-JUNIO-24/MOVACONCILIAR.json';
const apiMovimientosAgosto = 'https://cesarcruz-coto.github.io/coto/DATOS-JULIO-24/MOVACONCILIAR.json';
